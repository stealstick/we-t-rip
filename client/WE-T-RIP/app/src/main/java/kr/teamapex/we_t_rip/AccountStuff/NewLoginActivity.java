...
public class NewLoginActivity extends AppCompatActivity implements View.OnClickListener {
   ...
   /*비밀번호 유효성 검사*/
        ...
        if (cancel) {
            ...
            Toast.makeText(NewLoginActivity.this, "로그인 작동" + id + password, Toast.LENGTH_SHORT).show();
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                Toast.makeText(NewLoginActivity.this, "로그인 도중 오류가 발생하였습니다. 잠시후에 다시 시도해주세요", Toast.LENGTH_SHORT).show();
            }
        }

        @Override
        protected void onPreExecute() {
            dialog = ProgressDialog.show(NewLoginActivity.this, "잠시만 기다려주세요", "로그인 중입니다");
        }
